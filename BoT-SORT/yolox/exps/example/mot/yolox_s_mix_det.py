...
class Exp(MyExp):
    ...
    # def get_model(self):
    #     """
    #     Переопределяем базовый get_model() для совместимости с весами yolox_s.pth:
    #     строим backbone на YOLOPAFPN вместо CSPDarknet.
    #     """
    #     from yolox.models import YOLOX, YOLOPAFPN, YOLOXHead

    #     # если модель ещё не создана — создаём её
    #     if getattr(self, "model", None) is None:
    #         # строим ту же архитектуру, под которую обучены веса
