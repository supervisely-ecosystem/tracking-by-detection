...
def write_results(fname, results):
    """
    Записать результаты в MOT-формате:
    frame,id,x1,y1,x2,y2,score,-1,-1,-1
    """
...
def run_dual_tracking(args):
    """
    Инференс двух трекеров: оригинального BoT-SORT и BOXMOT.
    Сохраняет два .txt в MOT-формате в папку args.save_dir.
    """
